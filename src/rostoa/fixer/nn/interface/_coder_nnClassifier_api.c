...
void nnClassifier_api(const mxArray * const prhs[2], int32_T nlhs, const mxArray
                      *plhs[1])
{
  real_T rss;
  real_T ranging;
  ...
  isLOS = nnClassifier(rss, ranging);

  /* Marshall function outputs */
  plhs[0] = emlrt_marshallOut(isLOS);
}

void nnClassifier_atexit(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
  ...
  nnClassifier_xil_terminate();
}

void nnClassifier_initialize(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
void nnClassifier_terminate(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/* End of code generation (_coder_nnClassifier_api.c) */
